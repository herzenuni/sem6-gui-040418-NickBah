...
class main(Frame):
    ...
    def fileButtonClicked(self,event):
        ...
        try:
            ...
            self.n_input.delete(0,len(self.n_input.get()))
            self.n_input.insert(0,n-1)
    ...
    def __init__(self,master):
        ...
        self.canvas.create_window(0, 0, window=self.scrolling_area, width=10000, height=10000, anchor='nw')
